                                ...
                                <table id="style-2" class="table style-2  table-hover">
                                    ...
                                    @foreach($abouts as $about)
                                        <tr>
                                            ...
                                            <td class="text-center">{!! mb_strimwidth($about->description,0,80,',...') !!}</td>
                                            <td class="text-center">
                                                <span><img src="{{asset('uploads/'.$about->image)}}" class="rounded-circle profile-img" alt="avatar"></span>
                                            </td>
                                            <td class="text-center">
                                                <ul class="table-controls">
                                                    <li><a href="{{route('abouts.edit',['id' => $about->id])}}" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 p-1 br-6 mb-1"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a></li>
                                                    <li>
                                                        <form method="post" action="{{route('abouts.delete')}}">
                                                            @csrf
                                                            @method('DELETE')
