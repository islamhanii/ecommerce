...
{{--            </li>--}}
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="products" data-parent="#accordionExample">
                    ...
                    <li>
                        <a href="{{route('products.updatePage')}}"> Upload Updated Products </a>
                    </li>
                </ul>
            </li>
            <!-- ProductDetails -->
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="product_details" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('product.details.index')}}"> Show All Products Details </a>
                    </li>
                    <li>
                        <a href="{{route('product.details.create')}}"> Create New Product Details </a>
                    </li>
                </ul>
            </li>
            <!-- SizeUnit -->
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="size_units" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('size-unit.index')}}"> Show All Size Units </a>
                    </li>
                    <li>
                        <a href="{{route('size-unit.create')}}"> Create New Size Unit </a>
                    </li>
                </ul>
            </li>
            <!-- Sizes -->
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="slider" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('sliders.index')}}"> Show All Sliders </a>
                    </li>
                    <li>
                        <a href="{{route('sliders.create')}}"> Create New Slider </a>
                    </li>
                </ul>
            </li>
            <!-- About -->
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="detail" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('details.index')}}"> Show All Details </a>
                    </li>
                    <li>
            ...
            <!-- Policy Category -->
            <li class="menu">
                <a href="#policy_category" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-zap"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>
                ...
                <ul class="collapse submenu list-unstyled" id="policy_category" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('policy.categories.index')}}"> Show All Policy Categories </a>
                    </li>
                    <li>
                        <a href="{{route('policy.categories.create')}}"> Create New Policy Category </a>
                    </li>
                </ul>
            </li>
            <!-- Policies -->
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="policy" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('policies.index')}}"> Show All Policies </a>
                    </li>
                    <li>
