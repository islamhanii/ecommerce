    ...
    <div id="content" class="main-content">
        <div class="container">
            <div class="container my-5 mx-auto">
                ...
                <form class="form-vertical" action="{{route('advertisements.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group mb-4">
                        <label class="control-label">Advertisement Title:</label>
                        <input type="text" name="title" class="form-control @error('title') is-invalid fparsley-error parsley-error @enderror" placeholder="Advertisement Title" value="{{old('title')}}">
                        @error('title')
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="link" class="form-control @error('link') is-invalid fparsley-error parsley-error @enderror" placeholder="Advertisement Link" value="{{old('link')}}">
                        @error('link')
                        <span class="invalid-feedback text-danger" role="alert">
                          <p>{{ $message }}</p>
                        </span>
