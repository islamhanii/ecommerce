...
<div class="sidebar-closed sbar-open" >
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                <li class="menu active">
                    ...
                    <ul class="collapse submenu recent-submenu mini-recent-submenu list-unstyled show" id="dashboard" data-parent="#accordionExample">
                        ...
                        <li>
                            <a href="#colorspages" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                                Colors &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <ul class="collapse list-unstyled sub-submenu" id="colorspages" data-parent="#dashboard">
                                <li>
                                    <a href="{{ route('admin.colors.index') }}"> All Colors </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.colors.create') }}"> Add Color </a>
                                </li>
                            </ul>
                        </li>
                    </ul>
    ...
    <!-- row opened -->
    <div class="row row-sm header-container">
        <!--div-->
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">Show All Ads</h4>
                    </div>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex my-xl-auto right-content">
                                            <form method="post" action="{{route('admin.colors.delete', [$color->id])}}">
                                                @csrf
                                                @method('DELETE')
                                            ...
                                            <div class="pr-1 mb-3 mb-xl-0">
                                                <a type="button" href="{{route('admin.colors.updatePage', [$color->id])}}" class="btn btn-warning  btn-icon mr-2" data-placement="top" data-toggle="tooltip" title="Edit"><i class="fas fa-user-edit"></i>Edit</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
